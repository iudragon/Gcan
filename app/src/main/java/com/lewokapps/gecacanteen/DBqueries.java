            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    for (long x = 0; x < (long) task.getResult().get("list_size"); x++) {
                        ...
                        if (DBqueries.wishlist.contains(com.lewokapps.gecacanteen.ProductDetailsActivity.productID)) {

                            com.lewokapps.gecacanteen.ProductDetailsActivity.ALREADY_ADDED_TO_WISHLIST = true;

                            if (com.lewokapps.gecacanteen.ProductDetailsActivity.addToWishlistBtn != null) {

                                com.lewokapps.gecacanteen.ProductDetailsActivity.addToWishlistBtn.setSupportImageTintList(context.getResources().getColorStateList(R.color.colorAccent));
                            ...
                            if (com.lewokapps.gecacanteen.ProductDetailsActivity.addToWishlistBtn != null) {
                                ...
                                com.lewokapps.gecacanteen.ProductDetailsActivity.addToWishlistBtn.setSupportImageTintList(ColorStateList.valueOf(context.getResources().getColor(R.color.colorPrimary)));

                            }

                            com.lewokapps.gecacanteen.ProductDetailsActivity.ALREADY_ADDED_TO_WISHLIST = false;
                        }
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    for (long x = 0; x < (long) task.getResult().get("list_size"); x++) {
                        ...
                        if (DBqueries.speciallist.contains(com.lewokapps.gecacanteen.ProductDetailsActivity.productID)) {

                            com.lewokapps.gecacanteen.ProductDetailsActivity.ALREADY_ADDED_TO_SPECIALLIST = true;

                            if (com.lewokapps.gecacanteen.ProductDetailsActivity.addToSpeciallistBtn != null) {

                                com.lewokapps.gecacanteen.ProductDetailsActivity.addToSpeciallistBtn.setSupportImageTintList(context.getResources().getColorStateList(R.color.colorAccent));
                            ...
                            if (com.lewokapps.gecacanteen.ProductDetailsActivity.addToSpeciallistBtn != null) {
                                ...
                                com.lewokapps.gecacanteen.ProductDetailsActivity.addToSpeciallistBtn.setSupportImageTintList(ColorStateList.valueOf(context.getResources().getColor(R.color.colorPrimary)));

                            }

                            com.lewokapps.gecacanteen.ProductDetailsActivity.ALREADY_ADDED_TO_SPECIALLIST = false;
                        }
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    if (com.lewokapps.gecacanteen.ProductDetailsActivity.addToWishlistBtn != null) {
                        ...
                        com.lewokapps.gecacanteen.ProductDetailsActivity.addToWishlistBtn.setSupportImageTintList(ColorStateList.valueOf(context.getResources().getColor(R.color.btnRed)));
                    }
                ...
                com.lewokapps.gecacanteen.ProductDetailsActivity.running_wishlist_query = false;
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    if (com.lewokapps.gecacanteen.ProductDetailsActivity.addToSpeciallistBtn != null) {
                        ...
                        com.lewokapps.gecacanteen.ProductDetailsActivity.addToSpeciallistBtn.setSupportImageTintList(ColorStateList.valueOf(context.getResources().getColor(R.color.btnRed)));
                    }
                ...
                com.lewokapps.gecacanteen.ProductDetailsActivity.running_speciallist_query = false;
